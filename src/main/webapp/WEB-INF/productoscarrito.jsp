...
<body>
    ...
    <h4><strong><i>Carro > </strong></i> Proceso de pago > Revisi�n del pedido > �xito</h4>
    ...
    <div class="row">
      ...
      <div class="col-4">
        <div class="card text-center" id="card-costoestimado">
          <div>
            <h4 class="card-title" id="costo-estimado">Costo estimado de env�o</h4>
            <h5 style="text-align: left; margin-top:2rem; margin-left: 1rem;">Regi�n</h5>
            <select class="form-select" aria-label="Default select example" id="select-region">

              <option selected>Seleccione Regi�n</option>
            ...
            <button type="submit" id="calcular-envio-button">Calcular env�o</button>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-4">
        <div class="card" id="card-revisionpedido">
          <div>
            <h4 class="card-title" id="costo-estimado">Revisi�n del pedido</h4>
