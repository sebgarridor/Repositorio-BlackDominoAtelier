  ...
  <div class="container" id="divcentral">
    <div class="container-fluid">
      ...
      <p>Absolutamente todos los productos publicados son realizados de manera manual y a pedido, por tanto, al
        momento de confirmar tu compra se comenzarï¿½ la confecciï¿½n del producto.</p>
    </div>
    <br><br><br><br><br>
    ...
    <div class="container">
      ...
      <br><br><br><br>
      <h3 class="text-start">Crï¿½dito/Dï¿½bito</h3>
      <br><br>
      <p>El pago de los productos es posible realizarlos a travï¿½s de Webpay, Flow y Khipu (?). Dentro de estos
        sitios podrï¿½s realizar la compra con tarjetas de crï¿½dito y dï¿½bito emitidas por bancos nacionales, ademï¿½s
        de tarjetas prepago como MACH.</p>
      <br><br>
      <h3 class="text-start">Transferencia Elï¿½ctronica</h3>
      <br><br>
      <p>Ademï¿½s, tambiï¿½n estï¿½ habilitado el sistema de transferencia electrï¿½nica. Al finalizar tu compra y haber
        elegido el mï¿½todo de pago, se te entregarï¿½n los datos para realizar el pago. Despuï¿½s de haber realizado
        la transferencia, escrï¿½benos a blackdominoatelier@gmail.com o a nuestro Instagram para que confirmemos
        el depï¿½sito y asï¿½ comenzar con la confecciï¿½n de la prenda.</p>
      <br><br>
    </div>
    <br><br><br><br><br>
    <div class="container">
      <h1>Envios</h1>
      <br><br><br><br>
      <p>Por el momento, nuestros envï¿½os son realizados a travï¿½s de Starken dentro y fuera de la Regiï¿½n
        Metropolitana. Sin embargo, tambiï¿½n estï¿½ disponible la opciï¿½n para coordinar una entrega en la estaciï¿½n
        de metro Ciudad del Niï¿½o. Si optas por este mï¿½todo, escrï¿½benos a nuestro Instagram o mail para coordinar
        el dï¿½a y horario de entrega de tu producto.</p>
      <p>Si elegiste el envï¿½o a travï¿½s de Starken, tienes que considerar que el costo de envï¿½o viene generado en
        el total de la compra. Una vez confeccionada y enviada tu prenda, te enviaremos un cï¿½digo para el
        seguimiento del envï¿½o. Ojo, considera el tiempo de confecciï¿½n de cada prenda que suele tomar entre 5 a 7
        dï¿½as.</p>
    </div>
  </div>
