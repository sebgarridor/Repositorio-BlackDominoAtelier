  ...
  <div class="container" id="divcentral">
    <div class="container-fluid">
      ...
      <p>Absolutamente todos los productos publicados son realizados de manera manual y a pedido, por tanto, al
        momento de confirmar tu compra se comenzar� la confecci�n del producto.</p>
    </div>
    <br><br><br><br><br>
    ...
    <div class="container">
      ...
      <br><br><br><br>
      <h3 class="text-start">Cr�dito/D�bito</h3>
      <br><br>
      <p>El pago de los productos es posible realizarlos a trav�s de Webpay, Flow y Khipu (?). Dentro de estos
        sitios podr�s realizar la compra con tarjetas de cr�dito y d�bito emitidas por bancos nacionales, adem�s
        de tarjetas prepago como MACH.</p>
      <br><br>
      <h3 class="text-start">Transferencia El�ctronica</h3>
      <br><br>
      <p>Adem�s, tambi�n est� habilitado el sistema de transferencia electr�nica. Al finalizar tu compra y haber
        elegido el m�todo de pago, se te entregar�n los datos para realizar el pago. Despu�s de haber realizado
        la transferencia, escr�benos a blackdominoatelier@gmail.com o a nuestro Instagram para que confirmemos
        el dep�sito y as� comenzar con la confecci�n de la prenda.</p>
      <br><br>
    </div>
    <br><br><br><br><br>
    <div class="container">
      <h1>Envios</h1>
      <br><br><br><br>
      <p>Por el momento, nuestros env�os son realizados a trav�s de Starken dentro y fuera de la Regi�n
        Metropolitana. Sin embargo, tambi�n est� disponible la opci�n para coordinar una entrega en la estaci�n
        de metro Ciudad del Ni�o. Si optas por este m�todo, escr�benos a nuestro Instagram o mail para coordinar
        el d�a y horario de entrega de tu producto.</p>
      <p>Si elegiste el env�o a trav�s de Starken, tienes que considerar que el costo de env�o viene generado en
        el total de la compra. Una vez confeccionada y enviada tu prenda, te enviaremos un c�digo para el
        seguimiento del env�o. Ojo, considera el tiempo de confecci�n de cada prenda que suele tomar entre 5 a 7
        d�as.</p>
    </div>
  </div>
