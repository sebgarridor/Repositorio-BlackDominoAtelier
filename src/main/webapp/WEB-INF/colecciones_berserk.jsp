...
<body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 my-5">
          <div class="card">
            <img class="card-img-top card_color" src="assets/img/Hoodies/polerï¿½n Canguro Femto.png"
              alt="Card image cap">
          </div>
          <div class="product_card_body my-3">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 my-5">
          <div class="card">
            <img class="card-img-top card_color" src="assets/img/Polerones polo/polerï¿½n FEMTO.png"
              alt="Card image cap">
          </div>
          <div class="product_card_body my-3">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 my-5">
          <div class="card">
            <img class="card-img-top card_color" src="assets/img/Hoodies/polerï¿½n Canguro Griffith.png"
              alt="Card image cap">
          </div>
          <div class="product_card_body my-3">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 my-5">
          <div class="card">
            <img class="card-img-top card_color" src="assets/img/Polerones polo/polerï¿½n Griffith.png"
              alt="Card image cap">
          </div>
          <div class="product_card_body my-3">
