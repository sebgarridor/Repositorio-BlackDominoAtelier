...
<body>
    ...
    <div class="seccionmedio">
        <h1 class="encabezado">Coleccion Jujutsu Kaisen</h1>
        <br>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Poleras sin fondo/Fushiguro SF.png" alt="Polera Naruto">
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Poleras sin fondo/Nobara SF.png" alt="Polera Obito">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Nobara Tee</h5>
                        <h6 class="product_price my-2">$10.000 CLP</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/poler贸n Fushiguro.png" alt="Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Poler贸n polo Fushiguro</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/poler贸n Nobara.png"Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Poler贸n polo Nobara</h5>
                        <h6 class="product_price my-2">$20.000 CLP</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/poler贸n Canguro Fushiguro.png" alt="Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Poler贸n canguro Fushiguro</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/poler贸n Canguro Nobara.png" alt="Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Poler贸n canguro Nobara</h5>
                        <h6 class="product_price my-2">$23.000 CLP</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
