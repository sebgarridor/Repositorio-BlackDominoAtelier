    ...
    <div class="seccionmedio">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/polerón Fushiguro.png" alt="Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón polo Fushiguro</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/polerón Nobara.png"Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón polo Nobara</h5>
                        <h6 class="product_price my-2">$20.000 CLP</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/polerón Canguro Fushiguro.png" alt="Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón canguro Fushiguro</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/polerón Canguro Nobara.png" alt="Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón canguro Nobara</h5>
                        <h6 class="product_price my-2">$23.000 CLP</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
