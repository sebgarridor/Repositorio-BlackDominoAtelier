...
<body>
    ...
    <div class="seccionmedio">
        <h1 class="encabezado">Coleccion Evangelion</h1>
        <br>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Poleras sin fondo/EVA 01 SF.png" alt="Polera polo">
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Poleras sin fondo/Misato SF.png" alt="Polera polo">
                    </div>
                    <div class="product_card_body my-3">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/Poleron EVA-01.png" alt="Poleron">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón Polo EVA-01</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/polerón Misato.png" alt="Poleron">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón Polo Misato</h5>
                        <h6 class="product_price my-2">$20.000 CLP</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/polerón Canguro Eva-01.png" alt="Hoodie">
                    </div>
                    <div class="product_card_body my-3">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/polerón Canguro Misato.png" alt="Hoodie">
                    </div>
                    <div class="product_card_body my-3">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Bandolera EVA-01.png" alt="Bandolera">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Bandolera EVA-01</h5>
                        <h6 class="product_price my-2">$25.000 CLP</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
