    ...
    <div class="seccionmedio">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/poler贸n Mieruko.png" alt="Poleron polo Miko">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Poler贸n polo Miko</h5>
                        <h6 class="product_price my-2">$10.000 CLP</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/poler贸n Canguro Mieruko.png" alt="Poleron canguro Miko">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Poler贸n canguro Miko</h5>
