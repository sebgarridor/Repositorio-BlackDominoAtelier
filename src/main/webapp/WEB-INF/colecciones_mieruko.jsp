...
<body>
    ...
    <div class="seccionmedio">
        <h1 class="encabezado">Coleccion Mieruko-chan</h1>
        <br>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Poleras sin fondo/Mieruko SF.png" alt="Miko tee">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Miko Tee</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/polerón Mieruko.png" alt="Poleron polo Miko">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón polo Miko</h5>
                        <h6 class="product_price my-2">$10.000 CLP</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/polerón Canguro Mieruko.png" alt="Poleron canguro Miko">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón canguro Miko</h5>
