	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<body>
			...
			<div class="container-fluid" id="containerprincipal" style="margin-top: 5rem;">
				<div class="container">
					<div class="row">
						<div class="col-8" id="infocomprador">
							<div class="card" id="card-contenido">
								<div class="row">
									<h5 style="text-align:left; margin-left: 0%; color: #92478C;" class="card-title">
										Contacto</h5>
									<div class="col-6">
										<form>
											<div class="form-group text-start">
												...
												<input type="text" class="form-control" id="text-email"
													placeholder="Ingrese E-mail" style="margin-top:0.5rem; margin-bottom: 0.5rem;     color: white;
	  background: transparent;">
											</div>
											<div class="form-group text-start">
												<label for="text-rut" style="margin-bottom: 0.5rem;">Rut</label>
												<input type="text" class="form-control" id="text-rut"
													placeholder="Ingrese Rut" style="margin-top:0.5rem; margin-bottom: 0.5rem;     color: white;
	  background: transparent;">
											</div>
										</form>
									</div>
										...
										<form><!--  -->
											<div class="form-group text-start">
												<label for="text-telefono"
													style="margin-bottom: 0.5rem;">Teléfono</label>
												<input type="text" class="form-control" id="text-telefono"
													placeholder="Ingrese Teléfono" style="margin-top:0.5rem; margin-bottom: 0.5rem;     color: white;
	  background: transparent;">
											</div>
										</form>
									</div>
										...
										<form>
											<div class="form-group text-start">
												...
												<input type="text" class="form-control" id="text-nombre"
													placeholder="Ingrese Nombre" style="margin-top:0.5rem; margin-bottom: 0.5rem;     color: white;
	  background: transparent;">
											</div>
											<div class="form-group text-start">
												<label for="text-direccion"
													style="margin-bottom: 0.5rem;">Dirección</label>
												<input type="text" class="form-control" id="text-direccion"
													placeholder="Ingrese Dirección" style="margin-top:0.5rem; margin-bottom: 0.5rem;     color: white;
	  background: transparent;">
											</div>
											<div class="text-start">
												<label class="text-start" for="form-select"
													style="margin-bottom: 0.5rem;">Región</label>
										...
										<form>
											<div class="form-group text-start">
												<label for="text-apellidos"
													style="margin-bottom: 0.5rem;">Apellidos</label>
												<input type="text" class="form-control" id="text-apellidos"
													placeholder="Ingrese Apellidos" style="margin-top:0.5rem; margin-bottom: 0.5rem;    color: white;
	  background: transparent;">
											</div>
											<div class="form-group text-start">
												<label for="text-ciudad" style="margin-bottom: 0.5rem;">Ciudad</label>
												<input type="text" class="form-control" id="text-ciudad"
													placeholder="Ingrese Ciudad" style="margin-top:0.5rem; margin-bottom: 0.5rem;    color: white;
	  background: transparent;">
											</div>
											<div class="text-start">
										...
										<form>
											<div class="form-group text-start">
												<label for="formGroupExampleInput"
													style="margin-bottom: 0.5rem;">Nombre</label>
												<input type="text" class="form-control" id="text-nombre"
													placeholder="Ingrese Nombre" style="margin-top:0.5rem; margin-bottom: 0.5rem;    color: white;
	  background: transparent;">
											</div>
	  ...
	  background: transparent;">
											...
											<div class="form-group text-start">
												<label for="formGroupExampleInput"
													style="margin-bottom: 0.5rem;">Ciudad</label>
												<input type="text" class="form-control" id="text-ciudad"
													placeholder="Ingrese Ciudad" style="margin-top:0.5rem; margin-bottom: 0.5rem;    color: white;
	  background: transparent;">
											</div>
									...
									<div class="col-12">
										<div class="mb-3">
											<label for="exampleFormControlTextarea1" class="form-label"
												style="color: #6C757D;">Introduzca las
	  ...
	  background: transparent;" id="exampleFormControlTextarea1" rows="3"></textarea>
								...
								<div class="row">
									...
									<div class="col-6">
										<h5 style="text-align:left; margin-left: 0%; color: #92478C;"
											class="card-title">Opciones de pago
										</h5>
										<label class="form-control" style="color: white;">
											<div id="webpay-div"> <input type="radio" name="pago" />
												<img src="/assets/img/webpay.png" alt=""
													style="width: 6rem; margin-bottom: 1rem;">
											</div>
											<p style="font-size: small; text-align: center; color: #6c757d;">Será
												re-direccionado a Webpay Webservices
												para realizar su pago seguro</p>
										...
										<label class="form-control" style="color: white;">
											<div id="khipu-div">
												<input type="radio" name="pago" s />
												<img src="/assets/img/khipu.png" alt="" style="width: 6rem;">
											</div>
											<p style="font-size: small; text-align: center; color: #6c757d;">Será
												re-direccionado a Khipu
												Webservices para realizar su pago seguro</p>
										</label>
										<label class="form-control" style="color: white;">
											<div style="text-align:center">
												<input type="radio" name="pago" />
												<img src="assets/img/transferenciaicon.png" alt=""
													style="width: 3rem; ">

											</div>

											<p style="font-size: small; text-align: center; color: #6c757d;">
												Transferencia electrónica a Banco
												Estado</p>
										</label>
									</div>
									<div class="col-6">
										<h5 style="text-align:left; margin-left: 0%; color: #92478C;"
											class="card-title">Opciones de envío
										</h5>
										<label class="form-control" style="color: white;">
											<input type="radio" name="envio" />
											<p style="font-size: 0.8rem; text-align:left; margin-bottom: 4.2rem;">ENVIO
												POR PAGAR STARKEN<span> -
													Si es hacia agencia, poner en la dirección la agencia de
													destino.</span> </p>
										</label>
										...
										<label class="form-control" style="color: white;">
											...
											<p style="font-size: 0.8rem; text-align:left; margin-bottom: 3.3rem">ENVIO
												POR PAGAR REGIONES POR
												STARKEN <span> - Si es hacia agencia, poner en la dirección la agencia
													de destino.</span></p>
										</label>
										<label class="form-control" style="color: white;">
											<input type="radio" name="envio" />
											<p style="font-size: 0.8rem; text-align:left; margin-bottom: 2.8rem;">RETIRO
												EN ESTACIÓN CIUDAD DEL
												NIÑO <span>- Coordina con nosotros vía Instagram o Correo. </span> </p>
										</label>
									</div>
								</div>
						...
						<div class="col-4" id="revisionpedido">
							<div class="card" id="card-revisionpedido">
								<div>
									...
									<div class="container-fluid" id="subtotal">
										<br>
										<p style="margin-left: 0%;">Subtotal</p>
										<p style="display: inline-block;">$999.000CLP</p>
									</div>


									<br>
									<button type="submit" id="revisarcompra-button"
										onclick="location.href = '/revisionpedido';">Revisar
										la
										compra</button>
									<br>
									<button type="submit" id="editarcarrito-button"
										onclick="location.href = '/productoscarrito';">Editar
										carrito</button>
									<br>
									<button type="submit" id="seguircomprando-button"
										onclick="location.href = '/home';">Seguir
										comprando</button>
