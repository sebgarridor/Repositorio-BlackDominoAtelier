    ...
    <div class="seccionmedio">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/polerón Uzui.png" alt="Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón polo Uzui</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/polerón Gyutaro.png" alt="Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón Polo Gyutaro</h5>
                        <h6 class="product_price my-2">$20.000 CLP</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/polerón Canguro Uzui.png" alt="Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón canguro Uzui</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/polerón Canguro Gyutaro.png" alt="Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón canguro Gyutaro</h5>
                        <h6 class="product_price my-2">$23.000 CLP</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
