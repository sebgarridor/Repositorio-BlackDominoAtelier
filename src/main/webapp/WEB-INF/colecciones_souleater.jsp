...
<body>
    ...
    <div class="seccionmedio">
        <h1 class="encabezado">Coleccion Soul Eater</h1>
        <br>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Poleras sin fondo/Maka SF.png"
                            alt="Card image cap">
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/polerón Canguro Maka.png"
                            alt="Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/polerón Maka.png"
                            alt="Card image cap">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Maka Crewneck</h5>
                        <h6 class="product_price my-2">$28.990</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
