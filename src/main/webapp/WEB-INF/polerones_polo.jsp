	...
	<div class="container ">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Chrollo lucifer.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/Poleron Eren Tit�n.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
                    <h5 class="card-title product_title">Eren Tit�n Poleron Polo</h5>
                    <h6 class="product_price my-2">$28.990</h6>
                    <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n FEMTO.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Fireforce.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Fushiguro.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Gate FMA.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Genei Ryodan.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Griffith.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Gyutaro.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Hisoka.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Kaneda.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Kaneki.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Killua.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Maka.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Marin.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Mieruko.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Mikasa.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Misato.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Mob Pyscho.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Nobara.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Obito.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Punpun.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Shinji Bleach.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                <div class="card">
                    <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
                            src="assets/img/Polerones polo/poler�n Uzui.png" alt="Card image cap"></a>
                </div>
                <div class="product_card_body my-3">
