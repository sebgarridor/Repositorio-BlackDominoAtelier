...
<body>
    ...
    <div class="seccionmedio">
        <h1 class="encabezado">Coleccion Fire Force</h1>
        <br>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Poleras sin fondo/Fire force SF.png" alt="Polera polo">
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/polerón Fireforce.png" alt="Polerón polo">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón Polo Tamaki</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/polerón Canguro Fireforce.png" alt="Hoodie">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón Canguro Tamaki</h5>
