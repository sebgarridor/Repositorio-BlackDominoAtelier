    ...
    <div class="seccionmedio">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/poler贸n Fireforce.png" alt="Poler贸n polo">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Poler贸n Polo Tamaki</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/poler贸n Canguro Fireforce.png" alt="Hoodie">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Poler贸n Canguro Tamaki</h5>
