 ...
 <br><br><br><br><br>
    <div class="container" id="divcentral">
        <div class="container" id="estadocompra">
            <h4><span>Carro > Proceso de pago ></span> <strong>Revisi�n del pedido > </strong> �xito </h4>
        ...
        <div class="card" style="width: 100; margin-top: 3rem; margin-bottom: 4rem; padding: 2rem;">
            ...
            <div class="container" id="envio" style="text-align: left;">
                <h4 style="text-align: left; color: #92478C; margin-bottom: 2rem;">Env�o</h4>
                <p>Direcci�n:</p>
                <p>Ciudad:</p>
                <p>Comuna:</p>
                <p>Regi�n:</p>
