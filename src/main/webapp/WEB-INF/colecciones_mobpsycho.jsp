...
<body>
    ...
    <div class="seccionmedio">
        <h1 class="encabezado">Coleccion Mob Psycho</h1>
        <br>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Poleras sin fondo/Mob Psycho SF.png" alt="Polera Mob Psycho">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Mob Psycho Tee</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/polerón Mob Pyscho.png" alt="Poleron polo Mob psycho">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón polo Mob Psycho</h5>
                        <h6 class="product_price my-2">$10.000 CLP</h6>
                        <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/polerón Canguro Mob Psycho.png" alt="Poleron canguro Mob psycho">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Polerón canguro Mob Psycho</h5>
