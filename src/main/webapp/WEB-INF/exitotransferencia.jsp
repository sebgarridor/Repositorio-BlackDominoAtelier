        ...
        <div class="card" style="width: 100; margin-top: 3rem; margin-bottom: 4rem;">
            <div class="card-body">
                ...
                <p style="text-align: left;">Una vez tu compra sea procesada y confirmadapor nosotros comenzaremos con el proceso de
                    ...
                    dependiendo de quï¿½ tan grande sea el pedido. Dado que elegiste un mï¿½todo de transferencia electrï¿½nica,
                    tus productos serï¿½n confeccionados una vez hayas enviado el comprobante de depï¿½sito a alguno de nuestros medios digitales
                    , ya sea Instagram (@blackdomino.atelier) o correo (blackdominoatelier@gmail.com).
                </p>
                <h5 style="color: #92478C;">Datos de depï¿½sito</h5>
                <p><strong>Banco:</strong> Banco Estado</p>
                <p><strong>Nï¿½mero de cuenta:</strong> 1234 56789</p>
                ...
                <div class="container">
                    <div class="row">
                      ...
                      <div class="col" style="text-align: left;">
                        ...
                        <p>Transferencia Electrï¿½nica - <b>$30.000CLP</b></p>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col" style="text-align: left;">
