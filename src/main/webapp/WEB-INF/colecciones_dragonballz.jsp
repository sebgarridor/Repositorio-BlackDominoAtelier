...
<body>
    ...
    <h6 class="noti">Env锟給 delivery - Starken</h6>
    <header>
        <div>
    ...
    <div class="seccionmedio">
        <h1 class="encabezado">Coleccion Dragon Ball Z</h1>
        <br>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Poleras sin fondo/DragonBall SF.png" alt="Polera polo">
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Polerones polo/Poleron Dragon Ball Z.png" alt="Poleron">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Poler贸n Polo Dragon Ball Z</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                    <div class="card">
                        <img class="card-img-top card_color" src="assets/img/Hoodies/poler贸n Canguro Dragon Ball Z.png" alt="Hoodie">
                    </div>
                    <div class="product_card_body my-3">
                        <h5 class="card-title product_title">Poler贸n Canguro Dragon Ball Z</h5>
