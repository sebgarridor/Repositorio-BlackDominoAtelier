    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            ...
            <div class="seccionmedio">
                <h1 class="encabezado">Coleccion My Dress Up Darling</h1>
                <br>
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-4 my-5">
                            <div class="card">
                                <img class="card-img-top card_color"
                                    src="assets/img/Poleras sin fondo/AKIRA sin fondo1.png" alt="Card image cap">
                            </div>
