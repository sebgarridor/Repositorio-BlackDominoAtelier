...
<head>
    ...
    <title>Descripci�n producto</title>
...
<body>
    ...
    <div class="col">
      ...
      <div class="texto">
        ...
        <h5 class="textleft">Descripci�n</h5>
        <p class="textleft">Polera negra talla a elecci�n, estampada a trav�s de los m�todos artesanales
          serigraf�a.
      ...
      <div id="contadorYbutton">
        ...
        <!-- * BOTON A�ADIR AL CARRO -->
        <div>
         <button type="submit" id="carroboton">A�adir al carro</button>
          </form>
  ...
  <br><br><br><br><br>
  <!-- *SECCI�N DESTACADOS -->
  <h3 class="destacado text-center">Tambi�n te puede interesar</h3>
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <div class="flexdisplay">
          ...
          <div class="text-center">
            <img class="carruselimg d-block" src="assets/img/poler�n Eren tit�n.png" alt="foto">
