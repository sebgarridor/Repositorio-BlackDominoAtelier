...
<body>
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/AKIRA sin fondo1.png" alt="Card image cap"></a>
        </div>
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Chrollo Lucifer sin fondo.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Dazai Osamu SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/DEDE SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/DragonBall SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/EVA 01 SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Eren Titan SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
          <h5 class="card-title product_title">Eren Tit�n Tee</h5>
          <h6 class="product_price my-2">$10.000CLP</h6>
          <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
        </div>
      </div>
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/FEMTO SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Fire force SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Fushiguro SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/GATE FMA SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Genei Ryodan SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Griffith SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Hisoka SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/JUNJI sin fondo figma.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Kaneda SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Kaneki SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Killua SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Mikasa SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Maka SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Marin SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Mieruko SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Misato SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Mob Psycho SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Naruto SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Obito SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/PUM SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Shinji Bleach SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
          <h5 class="card-title product_title">Shinji Hirako Tee</h5>
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        ...
        <div class="product_card_body my-3">
          <h5 class="card-title product_title">Tamaki Tee</h5>
          <h6 class="product_price my-2">$28.990</h6>
          <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
        </div>
      </div>
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Uzui_s enemy SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
          <h5 class="card-title product_title">Gyutaro Tee</h5>
          <h6 class="product_price my-2">$28.990</h6>
          <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
        </div>
      </div>
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 my-5">
        <div class="card">
          <a class="imagenLink" href="/descripcionproducto.html"><img class="card-img-top card_color"
              src="assets/img/Poleras sin fondo/Uzui SF.png" alt="Card image cap"></a>
        </div>
        <div class="product_card_body my-3">
          <h5 class="card-title product_title">Uzui Tee</h5>
          <h6 class="product_price my-2">$28.990</h6>
          <a class="btn btn-primary px-5 option_btn">Ver Opciones</a>
        </div>
      </div>
